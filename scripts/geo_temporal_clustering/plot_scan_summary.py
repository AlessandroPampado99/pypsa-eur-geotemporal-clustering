...
SCAN_DIR = Path("resources/geotemporal_clustering_scan/400_mean_realmean_0.15_fixedpair")  # Directory containing the scan_summary.csv and final_shape_summary.csv
